...
"""
    ...
    The image is analyzed, its ROIs are extracted, cropped and saved to crop directory and the database.
"""
...
def analyze_image_crops():
    ...
    if payload is None:
        ...
        if result is None:
            ...
            # prepare return data, filename will be fetched according to the "test_id"
